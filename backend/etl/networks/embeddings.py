...
from backend.etl.networks.base import SingletonMeta
...
# TODO: create new branch and ship the vecotr db related code there
# TODO: Think about the path of the embeddings class
...
class EmbeddingFactory:
    ...
    def _build_hf_api(*, model_name: str, **kw) -> HuggingFaceInferenceAPIEmbeddings:
